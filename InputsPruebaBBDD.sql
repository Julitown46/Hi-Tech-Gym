...
INSERT INTO Pista (nombre, ubicación, estado) VALUES
('Pista 1', 'Zona A', 'disponible'),
('Pista 2', 'Zona B', 'disponible'),
('Pista 3', 'Zona C', 'mantenimiento');

-- Insertar pagos de membresías
INSERT INTO Pago (id_usuario, id_membresia, monto, fecha, método) VALUES
...
(1, 1, '2025-03-10', '10:00:00', 'confirmada'),
(2, 2, '2025-03-12', '16:00:00', 'confirmada');
